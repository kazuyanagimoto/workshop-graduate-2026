...
#cetz.canvas({
  ...
  content((0, 3.55), text(size: 10pt, weight: "bold", fill: cgray)[Remote])
  seg((0, 2.52), (0, 2.68), lc: cmain); tag(0, 2.9, "main")
  cm(0, 2.1, "C2")

  // pull the latest main down into the local repo
  arr((0, 1.65), (0, -0.05))
  content((0.3, 0.8), anchor: "west", text(size: 9pt, weight: "bold", fill: cdark)[git pull])
  ...
  content((0, -1.95), text(size: 10pt, weight: "bold", fill: cgray)[Local])
})
