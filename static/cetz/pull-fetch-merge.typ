...
#cetz.canvas({
  ...
  content((-0.65, 3.85), anchor: "west", text(size: 12pt, weight: "bold", fill: cgray)[Remote])
  cm(1.0, 2.6, "C3")
  ...
  content((2.0, 1.2), anchor: "east", text(size: 11pt, weight: "bold", fill: cdark)[1. fetch])
  ...
  content((-0.65, 0.7), anchor: "west", text(size: 12pt, weight: "bold", fill: cgray)[Local])
  ...
  arr((3.15, 0), (1.45, 0))
  content((2.3, 0.32), text(size: 11pt, weight: "bold", fill: cdark)[2. merge])
})
