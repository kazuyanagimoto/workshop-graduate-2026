...
環境をそろえるのがなぜ難しいのかは, パッケージの依存関係を見ると分かります. パッケージは単独では動かず, 1つ入れようとすると芋づる式に他のものまで必要になります. しかもその依存には, 性質の違う3つの種類があります ([Figure fig-dependency-kinds](#fig-dependency-kinds)).

[![](../static/cetz/dependency-kinds.svg)](../static/cetz/dependency-kinds.svg "Figure 2.1: パッケージの3種類の依存関係")

Figure 2.1: パッケージの3種類の依存関係
