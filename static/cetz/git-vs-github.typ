...
#cetz.canvas({
  ...
  arr((2.55, 0.45), (1.25, 1.82), lc: cdev)
  arr((1.75, 1.82), (3.05, 0.45), lc: cmain)
  content((-1.35, 0.8), text(size: 8pt, weight: "bold", fill: cdev)[push])
  content((-2.95, 1.5), text(size: 8pt, weight: "bold", fill: cmain)[pull])
  content((1.35, 0.8), text(size: 8pt, weight: "bold", fill: cdev)[push])
  content((2.95, 1.5), text(size: 8pt, weight: "bold", fill: cmain)[pull])
  ...
  content((5.3, 2.35), text(size: 10pt, fill: cdark)[Website])
  cap(5.3, 1.62, "GitHub Pages", col: cgray)
  arr((1.6, 2.35), (4.25, 2.35), lc: cmain)
  content((2.92, 2.62), text(size: 8pt, weight: "bold", fill: cmain)[host])
})
