...
#cetz.canvas({
  ...
  content((-0.45, 2.35), anchor: "west", text(size: 12pt, weight: "bold", fill: cgray)[Remote])
  ...
  content((3.2, -0.92), text(size: 11pt, weight: "bold", fill: cdark)[Pull Request merges dev into main])
})
